               ...
               <div className="row">
                  <div className="col-md-6">
                     <div className="coupon-accordion">
                        {/* <!-- ACCORDION START --> */}
                        <h3>Returning customer? <span onClick={()=> setCheckoutLogin(!checkoutLogin)} id="showlogin">
                           Click here to login</span></h3>
                           ...
                           <div className="coupon-info">
                              ...
                              <form action="#">
                                 ...
                                 <p className="form-row">
                                    <button className="m-btn m-btn-border-2 cta__btn active" type="submit">Login</button>
                                    <label>
                  ...
                  <div className="col-md-6">
                     <div className="coupon-accordion">
                        {/* <!-- ACCORDION START --> */}
                        <h3>Have a coupon? <span onClick={()=> setCheckoutCoupon(!checkoutCoupon)} id="showcoupon">
                           Click here to enter your code</span></h3>
                        {checkoutCoupon && <div className="coupon-checkout-content">
                           <div className="coupon-info">
                              <form action="#">
                                 <p className="checkout-coupon">
                                    <input type="text" placeholder="Coupon Code" />
                                    <button className="m-btn m-btn-border-2 cta__btn active" type="submit">Apply Coupon</button>
                                 </p>
                              </form>
                           </div>
                        </div>}
