      ...
      <>
          <section className="hero__area hero__height grey-bg-3 d-flex align-items-center">
            <div className="hero__shape">
               <Image className="circle" src="assets/img/icon/hero/hero-circle.png" alt="circle" />
               <Image className="circle-2" src="assets/img/icon/hero/hero-circle-2.png" alt="circle"/>
               <Image className="square" src="assets/img/icon/hero/hero-square.png" alt="circle"/>
               <Image className="square-2" src="assets/img/icon/hero/hero-square-2.png" alt="circle"/>
               <Image className="dot" src="assets/img/icon/hero/hero-dot.png" alt="circle"/>
               <Image className="triangle" src="assets/img/icon/hero/hero-triangle.png" alt="circle"/>
            </div>
                  ...
                  <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     <div className="hero__thumb-wrapper scene ml-70 p-relative">
                        <div className="hero__thumb one d-none d-lg-block">
                           <Image className="layer" data-depth="0.2" src="assets/img/hero/hero-1.jpg" alt=""/>
                        </div>
                        <div className="hero__thumb two d-none d-md-block">
                           <Image className="layer" data-depth="0.3" src="assets/img/hero/hero-2.jpg" alt=""/>
                        </div>
                        <div className="hero__thumb three d-none d-md-block">
                           <Image className="layer" data-depth="0.4" src="assets/img/hero/hero-3.jpg" alt=""/>
                        </div>
                     </div>
                  </div>
               </div>
