                           ...
                           <ul className="d-flex align-items-center">
                              <li>
                                 <div className="postbox__author-thumb-2">
                                    <Image src={blogItem.user_img} alt="" />
                                 </div>
                              </li>
                              <li>
                  ...
                  <div className="col-xxl-8 col-xl-8 col-lg-8">
                     <div className="postbox__wrapper">
                        <div className="postbox__thumb postbox__thumb-2 fix w-img mb-30">
                           <a href="#"><Image src={blogItem.img} alt="" /></a>
                        </div>
                        ...
                        <div className="postbox__thumb postbox__thumb-2 fix w-img mb-30">
                           <Image src="assets/img/blog/blog-2.jpg" alt="" />
                        </div>
                        <div className="postbox__details mb-30">
                        ...
                        <div className="postbox__author-3 d-sm-flex grey-bg-2 mb-85">
                           <div className="postbox__author-thumb-3 mr-20">
                              <Image src="assets/img/blog/author/blog-author-5.jpg" alt="" />
                           </div>
                           ...
                           <ul>
                                 ...
                                 <div className="comments-box grey-bg-2">
                                    <div className="comments-info d-flex">
                                       <div className="comments-avatar mr-15">
                                          <Image src="assets/img/product/support/sup-1.jpg" alt="" />
                                       </div>
                              ...
                              <li className="children">
                                 <div className="comments-box grey-bg-2">
                                    <div className="comments-info d-flex">
                                       <div className="comments-avatar mr-15">
                                          <Image src="assets/img/product/support/sup-2.jpg" alt="" />
                                       </div>
                                       <div className="avatar-name">
                                          <h5>Hilary Ouse</h5>
                        ...
                        <div className="comment__wrapper p-relative white-bg">
                           <div className="comment__shape">
                              <Image className="circle" src="assets/img/icon/sign/circle.png" alt="" />
                              <Image className="zigzag" src="assets/img/icon/sign/zigzag.png" alt="" />
                              <Image className="dot" src="assets/img/icon/sign/dot.png" alt="" />
                           </div>
